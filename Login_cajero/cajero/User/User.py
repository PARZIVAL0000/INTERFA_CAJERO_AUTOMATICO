...
def User(nombre, id):
    class Depositos(Frame):
        ...
        def __init__(self,*args, **kwargs):
            ...
            variable=self.DineroSeleccionado, value=1, command=self.opcionSeleccionado).grid(row=2,column=0, pady=20, padx=48,sticky="w")
            Radiobutton(self.marco, text="Depositar $20", 
            variable=self.DineroSeleccionado, value=2, command=self.opcionSeleccionado).grid(row=2,column=1, pady=20, padx=48,sticky="w")
            Radiobutton(self.marco, text="Depositar $50", 
            variable=self.DineroSeleccionado, value=3, command=self.opcionSeleccionado).grid(row=3,column=0, pady=20, padx=48,sticky="w")
            Radiobutton(self.marco, text="Depositar $100", 
            variable=self.DineroSeleccionado, value=4, command=self.opcionSeleccionado).grid(row=3,column=1, pady=20, padx=48,sticky="w")
            Radiobutton(self.marco, text="Depositar $200", 
            variable=self.DineroSeleccionado, value=5, command=self.opcionSeleccionado).grid(row=4,column=0, pady=20, padx=48,sticky="w")
            Radiobutton(self.marco, text="Depositar $500", 
            variable=self.DineroSeleccionado, value=6, command=self.opcionSeleccionado).grid(row=4,column=1, pady=20, padx=48,sticky="w")
            Radiobutton(self.marco, text="Depositar $700", 
            variable=self.DineroSeleccionado, value=7, command=self.opcionSeleccionado).grid(row=5,column=0, pady=20, padx=48,sticky="w")
            Radiobutton(self.marco, text="OTRO VALOR", 
            variable=self.DineroSeleccionado, value=8, command=self.opcionSeleccionado).grid(row=5,column=1, pady=20, padx=48,sticky="w")
    ...
    class Retiros(Frame):
        ...
        def __init__(self,*args, **kwargs):
            ...
            self.marco.grid(row=1, column=0, padx=40, pady=30, columnspan=2, sticky="n")
    ...
    class Transacciones(Frame):
        ...
        def __init__(self, *args, **kwargs):
            ...
            self.marco.grid(row=1, column=0, sticky="w", pady=20, ipadx=5)
    ...
    class Cuenta(Frame):
        ...
        def __init__(self, presupuesto ,*args, **kwargs):
            ...
            self.marco.grid(row=1, column=0, padx=50, pady=30, columnspan=2, sticky="n")
            
            self.NombresCliente = Label(self.marco, text="Nombres: ")
            self.NombresCliente.grid(row=2, column=0, sticky="w", pady=10, padx=30)
            self.EntryNombreCliente = Entry(self.marco, textvariable="Nombre", fg="black",justify="center")
            self.EntryNombreCliente.grid(row=2,column=1,sticky="e", pady=10, columnspan=2, padx=40)
            ...
            self.EntryCedulaCliente = Entry(self.marco, textvariable="Cedula", fg="black", justify="center")
            self.EntryCedulaCliente.grid(row=3,column=1,sticky="w", pady=10, padx=40)
            ...
            self.EntryTelefonoCliente = Entry(self.marco, textvariable="Telefono", fg="black", justify="center")
            self.EntryTelefonoCliente.grid(row=4,column=1,sticky="w", pady=10, padx=40)
            ...
            self.EntryEmailCliente = Entry(self.marco, textvariable="Email", fg="black", justify="center")
            self.EntryEmailCliente.grid(row=5,column=1,sticky="w", pady=10, padx=40)
            ...
            self.EntryProvinciaCliente = Entry(self.marco, textvariable="Provincia", fg="black", justify="center")
            self.EntryProvinciaCliente.grid(row=6,column=1,sticky="w", pady=10, padx=40)
            ...
            self.EntryPresupuestoCliente = Entry(self.marco, textvariable="Presupuesto", fg="black", justify="center")
            self.EntryPresupuestoCliente.insert(0, self.presupuesto)
            self.EntryPresupuestoCliente['state'] = 'readonly'
            self.EntryPresupuestoCliente.grid(row=7,column=1,sticky="w", pady=10, padx=40)
        ...
        def query_perfil(self):
            ...
            root.after(1000, self.query_perfil)
    ...
    class Historial(Frame):
        ...
        def __init__(self, *args, **kwargs):
            ...
            self.marco.grid(row=1, column=0, pady=30, sticky="ns", ipadx=5, columnspan=3)    
            ...
            variable=self.opcionHistorial, 
            value=2, 
            command=self.opcionVerificar).grid(row=2, column=1, pady=5, padx=15)
            ...
            self.LabeltextoDays = Label(self.marco, text="Día: ")
    ...
    class Usuario(Frame):
        def __init__(self, parent):
            ...
            self.informacionCuenta = Cuenta(self.presupuesto,self.notebook)
